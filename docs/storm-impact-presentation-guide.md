...
| **Depth band** | A slice of the reservoir by depth, such as 5-15 ft below the surface. The page summarises each cast by these slices. |
...
2. That muddy water did **not** spread evenly through the reservoir. It slid in
   as a layer **5 to 15 feet below the surface**. The surface stayed clear, and
...
depth runs top to bottom, in feet. Each column is one trip of the sonde. See
this bright stripe? It's the muddy storm water, 5 to 15 feet down. The top stays
clear. Over the next few days, the stripe moves deeper, to 15 to 25 feet, and
fades."
...
| Reservoir, 5-15 ft (turbidity, one sonde cast) | about 1.5 NTU | **18.9 NTU** | 12:06 PM, Aug 16, about 34 h after the river peak |
| Reservoir, 5-15 ft (daily median) | 1.5 NTU (Aug 13) | **15.6 NTU** | Aug 16 |
...
| Reservoir, 15-25 ft | 4.9 NTU | Jul 30, about 36 h after the river peak (river peak assumed at noon) |
...
**"Does it matter that the mud is 5 to 15 feet down?"**
